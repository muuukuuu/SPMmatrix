function [Data1,Data3,lamda,n_smooth]=clcSPMmtrx_ave2(fft_N,wave,freq_C,deltaF,fs)
...
Data1(1,1)=azim_data1();
Data1(1,2)=incl_data1(1);
Data1(1,3)=pol_data1(1);
Data3(1,1)=azim_data3(1);
Data3(1,2)=incl_data3(1);
Data3(1,3)=pol_data3(1);
